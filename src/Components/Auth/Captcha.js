...
const Captcha = (props) => {
  ...
  const handleInputChange = (e) => {
    ...
    // Call the parent's callback function to update isCaptchaValid
    // if (typeof props.onCaptchaValidityChange === "function") {
    //   props.onCaptchaValidityChange(isCaptchaValid);
    // }
  };
