...
const Navbar = () => {
  const { screenSize, setScreenSize, activeMenu, setActiveMenu, isCliked, setIsCliked, handleClick, currentColor } = useStateContext();
  ...
  // const NavButton = ({ title, customFunc, icon, color, dotColor }) => (
  //   <TooltipComponent
  //     content={title} position="ButtomCenter">
